...
const ShoppingCartModal: React.FC<ShoppingCartModalProps> = ({ items, onClose, onRemoveItem, onViewCart }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-end items-start z-50" onClick={handleBackgroundClick}>
      <div className="bg-white p-5 w-[350px] h-[650px] relative overflow-auto">
        ...
        <div className="mt-auto border-t pt-4">
          ...
          <div className="mt-4 flex flex-row gap-2">
            <button onClick={onClose} className="border border-black px-5 py-2 rounded-full">Cart</button>
            <button onClick={onViewCart} className="border border-black px-5 py-2 rounded-full">Checkout</button>
